...
cp -r $project_path/results/smiles_mlp/CHEMBL3979_EC50 /projects/prjs1021/JointChemicalModel/results/smiles_mlp/CHEMBL3979_EC50
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/smiles_mlp/CHEMBL3979_EC50
fi

cp -r $project_path/results/smiles_mlp/CHEMBL4005_Ki /projects/prjs1021/JointChemicalModel/results/smiles_mlp/CHEMBL4005_Ki
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/smiles_mlp/CHEMBL4005_Ki
fi

cp -r $project_path/results/smiles_mlp/CHEMBL4616_EC50 /projects/prjs1021/JointChemicalModel/results/smiles_mlp/CHEMBL4616_EC50
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/smiles_mlp/CHEMBL4616_EC50
fi

cp -r $project_path/results/smiles_mlp/CHEMBL262_Ki /projects/prjs1021/JointChemicalModel/results/smiles_mlp/CHEMBL262_Ki
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/smiles_mlp/CHEMBL262_Ki
fi

cp -r $project_path/results/smiles_mlp/CHEMBL237_Ki /projects/prjs1021/JointChemicalModel/results/smiles_mlp/CHEMBL237_Ki
if [ $? -eq 0 ]; then
