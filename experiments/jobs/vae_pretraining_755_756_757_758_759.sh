#!/bin/bash
#SBATCH --job-name=vae_pretraining_755_756_757_758_759
#SBATCH --output=/home/tilborgd/projects/JointChemicalModel/results/out/vae_pretraining_755_756_757_758_759.out
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH --ntasks=18
