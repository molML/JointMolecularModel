...
mv $project_path/results/cats_mlp/CHEMBL231_Ki /projects/prjs1021/JointChemicalModel/results/cats_mlp

mv $project_path/results/cats_mlp/CHEMBL264_Ki /projects/prjs1021/JointChemicalModel/results/cats_mlp

mv $project_path/results/cats_mlp/ESR1_ant /projects/prjs1021/JointChemicalModel/results/cats_mlp

mv $project_path/results/cats_mlp/CHEMBL1871_Ki /projects/prjs1021/JointChemicalModel/results/cats_mlp

mv $project_path/results/cats_mlp/TP53 /projects/prjs1021/JointChemicalModel/results/cats_mlp
