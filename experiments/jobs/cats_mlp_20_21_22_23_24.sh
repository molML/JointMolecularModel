...
cp -r $project_path/results/cats_mlp/CHEMBL231_Ki /projects/prjs1021/JointChemicalModel/results/cats_mlp/CHEMBL231_Ki
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/cats_mlp/CHEMBL231_Ki
fi

cp -r $project_path/results/cats_mlp/CHEMBL264_Ki /projects/prjs1021/JointChemicalModel/results/cats_mlp/CHEMBL264_Ki
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/cats_mlp/CHEMBL264_Ki
fi

cp -r $project_path/results/cats_mlp/ESR1_ant /projects/prjs1021/JointChemicalModel/results/cats_mlp/ESR1_ant
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/cats_mlp/ESR1_ant
fi

cp -r $project_path/results/cats_mlp/CHEMBL1871_Ki /projects/prjs1021/JointChemicalModel/results/cats_mlp/CHEMBL1871_Ki
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/cats_mlp/CHEMBL1871_Ki
fi

cp -r $project_path/results/cats_mlp/TP53 /projects/prjs1021/JointChemicalModel/results/cats_mlp/TP53
if [ $? -eq 0 ]; then
