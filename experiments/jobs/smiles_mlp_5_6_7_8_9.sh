#!/bin/bash
#SBATCH --job-name=smiles_mlp_5_6_7_8_9
#SBATCH --output=/home/tilborgd/projects/JointChemicalModel/results/out/smiles_mlp_5_6_7_8_9.out
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH --ntasks=18
...
cp -r $project_path/results/smiles_mlp/CHEMBL234_Ki /projects/prjs1021/JointChemicalModel/results/smiles_mlp/CHEMBL234_Ki
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/smiles_mlp/CHEMBL234_Ki
fi

cp -r $project_path/results/smiles_mlp/CHEMBL2971_Ki /projects/prjs1021/JointChemicalModel/results/smiles_mlp/CHEMBL2971_Ki
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/smiles_mlp/CHEMBL2971_Ki
fi

cp -r $project_path/results/smiles_mlp/CHEMBL2147_Ki /projects/prjs1021/JointChemicalModel/results/smiles_mlp/CHEMBL2147_Ki
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/smiles_mlp/CHEMBL2147_Ki
fi

cp -r $project_path/results/smiles_mlp/CHEMBL287_Ki /projects/prjs1021/JointChemicalModel/results/smiles_mlp/CHEMBL287_Ki
if [ $? -eq 0 ]; then
    rm -rf $project_path/results/smiles_mlp/CHEMBL287_Ki
fi

cp -r $project_path/results/smiles_mlp/CHEMBL238_Ki /projects/prjs1021/JointChemicalModel/results/smiles_mlp/CHEMBL238_Ki
if [ $? -eq 0 ]; then
