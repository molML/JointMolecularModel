...
mv $project_path/results/ecfp_mlp/CHEMBL4792_Ki /projects/prjs1021/JointChemicalModel/results/ecfp_mlp

mv $project_path/results/ecfp_mlp/CHEMBL4203_Ki /projects/prjs1021/JointChemicalModel/results/ecfp_mlp

mv $project_path/results/ecfp_mlp/CHEMBL219_Ki /projects/prjs1021/JointChemicalModel/results/ecfp_mlp

mv $project_path/results/ecfp_mlp/CHEMBL228_Ki /projects/prjs1021/JointChemicalModel/results/ecfp_mlp

mv $project_path/results/ecfp_mlp/CHEMBL2034_Ki /projects/prjs1021/JointChemicalModel/results/ecfp_mlp
