#!/bin/bash
#SBATCH --job-name=rnn_pretraining_35_36_37_38_39
#SBATCH --output=/home/tilborgd/projects/JointChemicalModel/results/out/rnn_pretraining_35_36_37_38_39.out
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH --ntasks=18
...
$HOME/anaconda3/envs/karman/bin/python -u $experiment_script_path -o $out_path -experiment 35 > "$log_path/${experiment_name}_35.log" &
pid1=$!
