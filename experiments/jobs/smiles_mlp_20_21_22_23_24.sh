...
mv $project_path/results/smiles_mlp/CHEMBL231_Ki /projects/prjs1021/JointChemicalModel/results/smiles_mlp

mv $project_path/results/smiles_mlp/CHEMBL264_Ki /projects/prjs1021/JointChemicalModel/results/smiles_mlp

mv $project_path/results/smiles_mlp/ESR1_ant /projects/prjs1021/JointChemicalModel/results/smiles_mlp

mv $project_path/results/smiles_mlp/CHEMBL1871_Ki /projects/prjs1021/JointChemicalModel/results/smiles_mlp

mv $project_path/results/smiles_mlp/TP53 /projects/prjs1021/JointChemicalModel/results/smiles_mlp
