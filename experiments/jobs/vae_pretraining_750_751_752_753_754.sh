#!/bin/bash
#SBATCH --job-name=vae_pretraining_750_751_752_753_754
#SBATCH --output=/home/tilborgd/projects/JointChemicalModel/results/out/vae_pretraining_750_751_752_753_754.out
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH --ntasks=18
