#!/bin/bash
#SBATCH --job-name=vae_pretraining_255_256_257_258_259
#SBATCH --output=/home/tilborgd/projects/JointChemicalModel/results/out/vae_pretraining_255_256_257_258_259.out
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH --ntasks=18
