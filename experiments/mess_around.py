...
config['batch_end_callback_every'] = 1000
hypers = experiment_settings['hyperparameters']

train_smiles = pd.read_csv(PATH_TRAIN_SMILES).smiles.tolist()[:1000000]
train_dataset = MoleculeDataset(train_smiles, descriptor=config['descriptor'], randomize_smiles=False)

val_smiles = pd.read_csv(PATH_VAL_SMILES).smiles.tolist()[:10000]
